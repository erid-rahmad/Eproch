<template>
    <div class="app-container">
        <div class="page-heading">
            <h2 v-text="$t('opusWebApp.country.home.createOrEditLabel')">
        ...
        >
            <el-form-item :label="$t('opusWebApp.country.name')" prop="name" required>
                <el-col :span="6">
                    <el-input v-model="country.name" required />
                </el-col>
            </el-form-item>
            <el-form-item :label="$t('opusWebApp.country.code')" prop="code" required>
                <el-col :span="6">
                    <el-input v-model="country.code" required />
                </el-col>
            </el-form-item>
            <el-form-item :label="$t('opusWebApp.country.currency')" prop="currency">
                <el-select
                    filterable

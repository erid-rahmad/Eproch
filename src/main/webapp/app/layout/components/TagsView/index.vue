...
import { TagsViewStoreModule as tagsViewStore, ITagViewState } from '@/shared/config/store/tags-view-store'
...
export default class extends Vue {
  ...
  private selectedTag: ITagViewState = {}
  private affixTags: ITagViewState[] = []
    ...
    this.$nextTick(() => {
      for (const tag of tags) {
        if ((tag.to as ITagViewState).path === this.$route.path) {
          ...
          if ((tag.to as ITagViewState).fullPath !== this.$route.fullPath) {
  ...
  private refreshSelectedTag(view: ITagViewState) {
  ...
  private closeSelectedTag(view: ITagViewState) {
  ...
  private closeAllTags(view: ITagViewState) {
  ...
  private toLastView(visitedViews: ITagViewState[], view: ITagViewState) {
  ...
  private openMenu(tag: ITagViewState, e: MouseEvent) {

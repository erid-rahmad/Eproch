...
export default class BiddingNegotiation extends mixins(AccessLevelMixin) {
  ...
  biddingNegotiations: any[] = [{
    id:2146553,
    prequalificationNo:'PREQ-100001',
    prequalificationName:'Prakualifikasi Kontrak Payung Buku Agenda',
    type:'Open',
  ...
  {
    id:2157652,
    prequalificationNo:'PQ-21080534',
    prequalificationName:'Kontrak payung untuk 1 Juta Buku Agenda',
    type:'Open',
    prequalificationStatus:'F',
    evaluationStatus:'APP',
    vendorCount:2,

<template>
    <div class="prequalification-process">
        <div v-if="index===0" >
            <!--
        ...
        <div v-if="index===1">
            <SubmissionForm :data="data" @close="close_" @setReadOnly="setReadOnly"></SubmissionForm>
        </div>
    </div>
</template>

<script lang="ts" src="./submission-list.component.ts"></script>

    ...
    <div class="add-announcement">
        ...
        <el-row :gutter="24">
            <el-col :xs="24" :sm="12" :lg="12">
                <el-form ref="form" :model="sizeForm" label-width="259px" size="mini">
                    <el-form-item label="Tanggal Pengumuman">
                        <el-input v-model="sizeForm.name"></el-input>
                    </el-form-item>
                    <el-form-item label="Upload File Pengumuman ">
                        <el-button type="primary" size="mini" @click="onSubmit">Chose File</el-button>
                    </el-form-item>
                    <el-form-item>
                        <P>(Pdf / Maksimal :2048 KB)</P>
                    </el-form-item>
                </el-form>
            </el-col>
            <el-col :xs="24" :sm="12" :lg="12">
            ...
            <el-col :xs="24" :sm="12" :lg="17">
                ...
                <el-col :span="20">
                    <el-table v-loading="processing" ref="biddingSchedule" highlight-current-row border stripe size="mini" style="width: 100%; height: 100%" :data="tableData1">
                        ...
                        <el-table-column min-width="120" prop="name" label="Nama Penyedia" />
                        <el-table-column min-width="100" prop="status" label="Hasli Evaluasi" />
                        <el-table-column min-width="100" prop="email" label="Email" />
                    </el-table>
                </el-col>
            </el-col>
        </el-row>

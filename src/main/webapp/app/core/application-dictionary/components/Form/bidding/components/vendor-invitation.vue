<template>
    <div class="vendor-invitation">
        ...
        >
            ...
            <template>
                <div>
                    <el-form ref="vendorSuggestion" :model="vendorSuggestion" label-position="left" label-width="150px"
                             size="mini">
                        <el-row :gutter="24">
                            <el-col :span="24">
                        ...
                        <el-row :gutter="24">
                            <el-col :span="24">
                                <el-form-item label="Address" prop="address" required>
                                    <el-input v-model="vendorSuggestion.address" class="form-input" clearable disabled/>
                                </el-form-item>
                            </el-col>
                        </el-row>

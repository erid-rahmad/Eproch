    ...
    >
      <el-row :gutter="24">
        <el-col :xs="24" :sm="24" :lg="18" :xl="8">
          <el-form-item label="Prequalification No." prop="prequalificationId">
            <el-select v-model="formData.prequalificationId" clearable :disabled="!newRecord" filterable @change="retrieveVendorSuggestions">
              <el-option v-for="item in preqData" :key="item.id" :label="item.documentNo" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :xs="24" :sm="24" :lg="18" :xl="8">
          <el-form-item label="Prequalification Title">
            <el-select v-model="formData.prequalificationId" clearable disabled filterable>
              <el-option v-for="item in preqData" :key="item.id" :label="item.name" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
      </el-row>

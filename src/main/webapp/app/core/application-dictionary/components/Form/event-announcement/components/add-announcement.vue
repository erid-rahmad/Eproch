<template>
  <div class="add-announcement">
    ...
    >
      ...
      <el-row :gutter="24">
        <el-col :xs="24" :sm="24" :lg="18" :xl="16">
          ...
          <el-form-item>
            <el-button v-if="!attachmentName" size="mini" type="primary" @click="attachmentFormVisible = true">
              <svg-icon name="icomoo/206-attachment"></svg-icon> Attachment
            </el-button>
            <el-button v-if="attachmentName" icon="el-icon-view" size="mini" type="primary" @click="handlePreview">
              {{ attachmentName }}
            </el-button>
            <el-button v-if="attachmentName" icon="el-icon-close" size="mini" type="primary" @click="cancelAttachment"></el-button>
    ...
    <el-dialog title="Publish Email" :visible.sync="recipientListVisible" @open="retrieveEmailList">
      <el-table v-loading="loadingEmailList" border :data="emailList" size="mini" stripe @selection-change="handleSelectionChange">

    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">OpusWebApp</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/currency">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.currency')">Currency</span>
                    </b-dropdown-item>
                    ...
                    <b-dropdown-item to="/business-category">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.businessCategory')">BusinessCategory</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/supporting-document">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.supportingDocument')">SupportingDocument</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/document-type">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.documentType')">DocumentType</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/document-type-business-category">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.documentTypeBusinessCategory')">DocumentTypeBusinessCategory</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/person-in-charge">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.personInCharge')">PersonInCharge</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/company-functionary">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.companyFunctionary')">CompanyFunctionary</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/reference">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.reference')">Reference</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/reference-list">
                        <font-awesome-icon icon="asterisk" />
                    ...
                    <b-dropdown-item to="/ad-client">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adClient')">ADClient</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-organization">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adOrganization')">ADOrganization</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-table">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adTable')">ADTable</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-column">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adColumn')">ADColumn</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-window">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adWindow')">ADWindow</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-tab">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adTab')">ADTab</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-field">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.adField')">ADField</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/ad-field-group">
                        <font-awesome-icon icon="asterisk" />
                    ...
                    <b-dropdown-item to="/c-country">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cCountry')">CCountry</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/c-currency">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cCurrency')">CCurrency</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/c-region">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cRegion')">CRegion</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/c-city">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cCity')">CCity</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/c-location">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cLocation')">CLocation</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/c-bank">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cBank')">CBank</span>
                    </b-dropdown-item>

...
public class CPrequalificationEventLineService {
    ...
    public List<CPrequalificationEventLineDTO> findByEventTypeId(Long id) {
        return cPrequalificationEventLineMapper.toDto(cPrequalificationEventLineRepository.findByPrequalificationEvent_IdOrderBySequence(id));
    }
}

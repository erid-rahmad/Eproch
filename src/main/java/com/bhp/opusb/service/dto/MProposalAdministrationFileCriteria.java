...
/**
 * Criteria class for the {@link com.bhp.opusb.domain.MProposalAdministrationFile} entity. This class is used
 * in {@link com.bhp.opusb.web.rest.MProposalAdministrationFileResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-proposal-administration-files?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MProposalAdministrationFileCriteria implements Serializable, Criteria {
    ...
    public MProposalAdministrationFileCriteria() {
    }

    public MProposalAdministrationFileCriteria(MProposalAdministrationFileCriteria other) {
    ...
    @Override
    public MProposalAdministrationFileCriteria copy() {
        return new MProposalAdministrationFileCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MProposalAdministrationFileCriteria that = (MProposalAdministrationFileCriteria) o;
        return
    ...
    public String toString() {
        return "MProposalAdministrationFileCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (uid != null ? "uid=" + uid + ", " : "") +

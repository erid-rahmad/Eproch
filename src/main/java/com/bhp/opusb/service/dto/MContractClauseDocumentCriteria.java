...
/**
 * Criteria class for the {@link com.bhp.opusb.domain.MContractClauseDocument} entity. This class is used
 * in {@link com.bhp.opusb.web.rest.MContractClauseDocumentResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-contract-clause-documents?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MContractClauseDocumentCriteria implements Serializable, Criteria {
    ...
    public MContractClauseDocumentCriteria() {
    }

    public MContractClauseDocumentCriteria(MContractClauseDocumentCriteria other) {
    ...
    @Override
    public MContractClauseDocumentCriteria copy() {
        return new MContractClauseDocumentCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MContractClauseDocumentCriteria that = (MContractClauseDocumentCriteria) o;
        return
    ...
    public String toString() {
        return "MContractClauseDocumentCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
                (type != null ? "type=" + type + ", " : "") +

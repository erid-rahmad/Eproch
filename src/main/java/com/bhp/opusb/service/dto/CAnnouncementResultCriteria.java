...
/**
 * Criteria class for the {@link com.bhp.opusb.domain.CAnnouncementResult} entity. This class is used
 * in {@link com.bhp.opusb.web.rest.CAnnouncementResultResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /c-announcement-results?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CAnnouncementResultCriteria implements Serializable, Criteria {
    ...
    public CAnnouncementResultCriteria() {
    }

    public CAnnouncementResultCriteria(CAnnouncementResultCriteria other) {
    ...
    @Override
    public CAnnouncementResultCriteria copy() {
        return new CAnnouncementResultCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CAnnouncementResultCriteria that = (CAnnouncementResultCriteria) o;
        return
    ...
    public String toString() {
        return "CAnnouncementResultCriteria{" +
                (id != null ? "id=" + id + ", " : "") +

...
public class MProposalTechnicalFileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MProposalTechnicalFileDTO mProposalTechnicalFileDTO = (MProposalTechnicalFileDTO) o;
        if (mProposalTechnicalFileDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mProposalTechnicalFileDTO.getId());
    }
    ...
    public String toString() {
        return "MProposalTechnicalFileDTO{" +
            "id=" + getId() +
            ", uid='" + getUid() + "'" +
            ", active='" + isActive() + "'" +

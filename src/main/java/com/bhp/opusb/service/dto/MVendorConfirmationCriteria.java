...
/**
 * Criteria class for the {@link com.bhp.opusb.domain.MVendorConfirmation} entity. This class is used
 * in {@link com.bhp.opusb.web.rest.MVendorConfirmationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-vendor-confirmations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MVendorConfirmationCriteria implements Serializable, Criteria {
    ...
    public MVendorConfirmationCriteria() {
    }

    public MVendorConfirmationCriteria(MVendorConfirmationCriteria other) {
    ...
    @Override
    public MVendorConfirmationCriteria copy() {
        return new MVendorConfirmationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MVendorConfirmationCriteria that = (MVendorConfirmationCriteria) o;
        return
    ...
    public String toString() {
        return "MVendorConfirmationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (uid != null ? "uid=" + uid + ", " : "") +

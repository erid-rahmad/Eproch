...
/**
 * Criteria class for the {@link com.bhp.opusb.domain.CTaxCategory} entity. This class is used
 * in {@link com.bhp.opusb.web.rest.CTaxCategoryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /c-tax-categories?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class CTaxCategoryCriteria implements Serializable, Criteria {
    ...
    private BooleanFilter isWithholding;
    ...
    public CTaxCategoryCriteria(CTaxCategoryCriteria other) {
    ...
    @Override
    public CTaxCategoryCriteria copy() {
        return new CTaxCategoryCriteria(this);
    }
    ...
    public BooleanFilter getIsWithholding() {
        return isWithholding;
    }

    public void setIsWithholding(BooleanFilter isWithholding) {
    ...
    public boolean equals(Object o) {
        ...
        final CTaxCategoryCriteria that = (CTaxCategoryCriteria) o;
        return

 ...
 */
@Mapper(componentModel = "spring", uses = {ADOrganizationMapper.class, CCurrencyMapper.class, CCostCenterMapper.class, AdUserMapper.class})
public interface MAuctionMapper extends EntityMapper<MAuctionDTO, MAuction> {
    ...
    @Mapping(source = "owner.user.id", target = "ownerUserId")

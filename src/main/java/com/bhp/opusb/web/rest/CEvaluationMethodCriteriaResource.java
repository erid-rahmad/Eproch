...
public class CEvaluationMethodCriteriaResource {
    ...
    public ResponseEntity<CEvaluationMethodCriteriaDTO> createCEvaluationMethodCriteria(@RequestBody CEvaluationMethodCriteriaDTO cEvaluationMethodCriteriaDTO) throws URISyntaxException {
    ...
    public ResponseEntity<CEvaluationMethodCriteriaDTO> updateCEvaluationMethodCriteria(@RequestBody CEvaluationMethodCriteriaDTO cEvaluationMethodCriteriaDTO) throws URISyntaxException {

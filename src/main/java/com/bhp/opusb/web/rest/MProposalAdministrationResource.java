...
public class MProposalAdministrationResource {
    ...
    /**
     * {@code POST  /m-proposal-administrations/requirements} : Create or update mProposalAdministrations.
     *
     ...
     */
    @PostMapping("/m-proposal-administrations/requirements")
    public ResponseEntity<List<MProposalAdministrationDTO>> createMProposalAdministrations(@Valid @RequestBody List<MProposalAdministrationDTO> mProposalAdministrationDTOs) {
        log.debug("REST request to save MProposalAdministrations. size : {}", mProposalAdministrationDTOs.size());
        List<MProposalAdministrationDTO> result = mProposalAdministrationService.saveRequirements(mProposalAdministrationDTOs);

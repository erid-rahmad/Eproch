...
@RestController
@RequestMapping("/api/opus-web-app-kafka")
public class OpusWebAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OpusWebAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OpusWebAppKafkaResource(KafkaProperties kafkaProperties) {

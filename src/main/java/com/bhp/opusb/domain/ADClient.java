...
public class ADClient extends AbstractAuditingEntity implements Serializable {
    ...
    public ADClient name(String name) {
        this.name = name;
        return this;
    }
    ...
    public ADClient code(String code) {
        this.code = code;
        return this;
    }
    ...
    public ADClient description(String description) {
    ...
    public ADClient active(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ADClient)) {
            return false;
        }
        return id != null && id.equals(((ADClient) o).id);
    }

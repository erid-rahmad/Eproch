...
export default class ADFieldComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-field-heading'));
...
export class ADFieldDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.aDField.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-aDField'));
}

...
export default class ReferenceListComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('reference-list-heading'));
...
export class ReferenceListDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.referenceList.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-referenceList'));
}

...
export default class BusinessCategoryComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('business-category-heading'));
...
export class BusinessCategoryDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.businessCategory.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-businessCategory'));
}

...
export default class CurrencyComponentsPage extends AlertPage {
...
export class CurrencyDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.currency.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-currency'));
}

...
export default class CompanyFunctionaryComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('company-functionary-heading'));
...
export class CompanyFunctionaryDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.companyFunctionary.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-companyFunctionary'));
}

...
export default class ADColumnComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-column-heading'));
...
export class ADColumnDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.aDColumn.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-aDColumn'));
}

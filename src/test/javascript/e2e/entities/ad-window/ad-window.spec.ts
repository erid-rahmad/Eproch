...
import ADWindowComponentsPage, { ADWindowDeleteDialog } from './ad-window.page-object';
import ADWindowUpdatePage from './ad-window-update.page-object';
import ADWindowDetailsPage from './ad-window-details.page-object';
...
describe('ADWindow e2e test', () => {
  let navBarPage: NavBarPage;
  let updatePage: ADWindowUpdatePage;
  let detailsPage: ADWindowDetailsPage;
  let listPage: ADWindowComponentsPage;
  /*let deleteDialog: ADWindowDeleteDialog;*/
  ...
  it('should load ADWindows', async () => {
    await navBarPage.getEntityPage('ad-window');
    listPage = new ADWindowComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create ADWindow page', async () => {
      await listPage.createButton.click();
      updatePage = new ADWindowUpdatePage();

      await waitUntilAllDisplayed([updatePage.title, updatePage.footer, updatePage.saveButton]);

      expect(await updatePage.title.getAttribute('id')).to.match(/opusWebApp.aDWindow.home.createOrEditLabel/);
    });

    /* it('should create and save ADWindows', async () => {
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      after(async () => {
        ...
        deleteDialog = new ADWindowDeleteDialog();
        await waitUntilDisplayed(deleteDialog.dialog);

        expect(await deleteDialog.title.getAttribute('id')).to.match(/opusWebApp.aDWindow.delete.question/);
      ...
      it('should load details ADWindow page and fetch data', async () => {

        const detailsButton = listPage.getDetailsButton(listPage.records.first());
        await click(detailsButton);

        detailsPage = new ADWindowDetailsPage();
      ...
      it('should load edit ADWindow page, fetch data and update', async () => {

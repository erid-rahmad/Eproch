...
export default class PermissionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('permission-heading'));
...
export class PermissionDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.permission.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-permission'));
}

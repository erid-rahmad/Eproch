...
export default class CGalleryItemComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-gallery-item-heading'));
...
export class CGalleryItemDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cGalleryItem.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cGalleryItem'));
}

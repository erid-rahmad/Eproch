...
export default class LocationComponentsPage extends AlertPage {
...
export class LocationDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.location.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-location'));
}

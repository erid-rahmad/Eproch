...
export default class ADFieldGroupComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-field-group-heading'));
...
export class ADFieldGroupDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.aDFieldGroup.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-aDFieldGroup'));
}

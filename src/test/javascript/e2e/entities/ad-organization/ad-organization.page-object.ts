...
export default class ADOrganizationComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-organization-heading'));
...
export class ADOrganizationDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.aDOrganization.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-aDOrganization'));
}

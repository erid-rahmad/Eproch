...
export default class VendorComponentsPage extends AlertPage {
...
export class VendorDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.vendor.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-vendor'));
}

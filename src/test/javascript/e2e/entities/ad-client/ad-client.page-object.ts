...
export default class ADClientComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-client-heading'));
...
export class ADClientDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.aDClient.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-aDClient'));
}

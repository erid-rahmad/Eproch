...
export default class CRegionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-region-heading'));
...
export class CRegionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cRegion.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cRegion'));
}

...
export default class CCityComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-city-heading'));
...
export class CCityDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cCity.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cCity'));
}

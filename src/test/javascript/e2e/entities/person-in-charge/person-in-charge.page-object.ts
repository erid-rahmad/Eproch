...
export default class PersonInChargeComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('person-in-charge-heading'));
...
export class PersonInChargeDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.personInCharge.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-personInCharge'));
}

...
export default class ADTableComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-table-heading'));
...
export class ADTableDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.aDTable.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-aDTable'));
}

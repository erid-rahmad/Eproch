...
export default class CCountryComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-country-heading'));
...
export class CCountryDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cCountry.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cCountry'));
}

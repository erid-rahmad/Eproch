...
export default class CGalleryComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-gallery-heading'));
...
export class CGalleryDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cGallery.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cGallery'));
}

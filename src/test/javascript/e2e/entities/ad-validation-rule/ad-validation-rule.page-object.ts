...
export default class AdValidationRuleComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ad-validation-rule-heading'));
...
export class AdValidationRuleDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.adValidationRule.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-adValidationRule'));
}

...
export default class SupportingDocumentComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('supporting-document-heading'));
...
export class SupportingDocumentDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.supportingDocument.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-supportingDocument'));
}

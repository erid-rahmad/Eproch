...
export default class DocumentTypeComponentsPage extends AlertPage {
...
export class DocumentTypeDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.documentType.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-documentType'));
}

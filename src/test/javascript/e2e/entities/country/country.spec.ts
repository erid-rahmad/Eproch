...
import CountryDetailsPage from './country-details.page-object';
...
describe('Country e2e test', () => {
  ...
  it('should load Countries', async () => {
    ...
    listPage = new CountryComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create Country page', async () => {
      ...
      updatePage = new CountryUpdatePage();
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/opusWebApp.country.delete.question/);

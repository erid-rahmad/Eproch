...
export default class CountryComponentsPage extends AlertPage {
...
export class CountryDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.country.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-country'));
}

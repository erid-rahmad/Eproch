...
export default class CLocationComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-location-heading'));
...
export class CLocationDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cLocation.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cLocation'));
}

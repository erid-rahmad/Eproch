...
export default class CCurrencyComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-currency-heading'));
...
export class CCurrencyDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cCurrency.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cCurrency'));
}

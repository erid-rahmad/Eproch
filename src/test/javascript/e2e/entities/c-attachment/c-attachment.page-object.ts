...
export default class CAttachmentComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('c-attachment-heading'));
...
export class CAttachmentDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.cAttachment.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cAttachment'));
}

...
export default class CityComponentsPage extends AlertPage {
...
export class CityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('opusWebApp.city.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-city'));
}

...
export default class ReferenceComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('reference-heading'));
...
export class ReferenceDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('opusWebApp.reference.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-reference'));
}

...
import ReferenceDetailsPage from './reference-details.page-object';
...
describe('Reference e2e test', () => {
  ...
  let updatePage: ReferenceUpdatePage;
  let detailsPage: ReferenceDetailsPage;
  let listPage: ReferenceComponentsPage;
  let deleteDialog: ReferenceDeleteDialog;
  ...
  it('should load References', async () => {
    ...
    listPage = new ReferenceComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create Reference page', async () => {
      ...
      updatePage = new ReferenceUpdatePage();

      await waitUntilAllDisplayed([updatePage.title, updatePage.footer, updatePage.saveButton]);

      expect(await updatePage.title.getAttribute('id')).to.match(/opusWebApp.reference.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        deleteDialog = new ReferenceDeleteDialog();
        await waitUntilDisplayed(deleteDialog.dialog);

        expect(await deleteDialog.title.getAttribute('id')).to.match(/opusWebApp.reference.delete.question/);
      ...
      it('should load details Reference page and fetch data', async () => {
        const detailsButton = listPage.getDetailsButton(listPage.records.first());
        await click(detailsButton);

        detailsPage = new ReferenceDetailsPage();
      ...
      it('should load edit Reference page, fetch data and update', async () => {

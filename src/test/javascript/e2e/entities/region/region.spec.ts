...
describe('Region e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Region page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/opusWebApp.region.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/opusWebApp.region.delete.question/);

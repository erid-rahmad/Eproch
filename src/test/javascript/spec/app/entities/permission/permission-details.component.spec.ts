...
import PermissionDetailComponent from '@/entities/permission/permission-details.vue';
import PermissionClass from '@/entities/permission/permission-details.component';
...
describe('Component Tests', () => {
  describe('Permission Management Detail Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PermissionClass>(PermissionDetailComponent, {
        store,
        i18n,
        localVue,
        provide: { permissionService: () => permissionServiceStub }
      });
      comp = wrapper.vm;
    });

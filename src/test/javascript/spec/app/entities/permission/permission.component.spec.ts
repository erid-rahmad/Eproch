...
import PermissionComponent from '@/entities/permission/permission.vue';
import PermissionClass from '@/entities/permission/permission.component';
...
describe('Component Tests', () => {
  describe('Permission Management Component', () => {
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(permissionServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(permissionServiceStub.retrieve.callCount).toEqual(3);
